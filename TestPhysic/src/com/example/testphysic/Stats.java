...
public class Stats extends BaseScene implements IOnMenuItemClickListener
{
	...
	public void createScene() 
	{
		...
		attachChild(new Text(250, engine.getCamera().getCenterY() + 150, resourcesManager.font,    "ennemies killed :" , vbom));
		attachChild(new Text(250, engine.getCamera().getCenterY() + 100, resourcesManager.font,    "coin collected  :", vbom));
		attachChild(new Text(250, engine.getCamera().getCenterY() + 50, resourcesManager.font,     "kilometers done :", vbom));
		attachChild(new Text(250, engine.getCamera().getCenterY(), resourcesManager.font,          "best score      :", vbom));
		attachChild(new Text(250, engine.getCamera().getCenterY() - 50, resourcesManager.font,     "jump number     :" , vbom));
		attachChild(new Text(250, engine.getCamera().getCenterY() - 100, resourcesManager.font,    "Scene reach     :" , vbom));
		attachChild(new Text(250, engine.getCamera().getCenterY() - 150, resourcesManager.font,    "trap destroyed  :" , vbom));
		
		attachChild(new Text(600, engine.getCamera().getCenterY() + 150, resourcesManager.font,ennemie_killed, vbom));
		attachChild(new Text(600, engine.getCamera().getCenterY() + 100, resourcesManager.font,coin_collected, vbom));
		attachChild(new Text(600, engine.getCamera().getCenterY() + 50, resourcesManager.font,killometers_done,vbom));
		attachChild(new Text(600, engine.getCamera().getCenterY(), resourcesManager.font,Best_score, vbom));
		attachChild(new Text(600, engine.getCamera().getCenterY() - 50, resourcesManager.font,jump_stat, vbom));
		attachChild(new Text(600, engine.getCamera().getCenterY() - 100, resourcesManager.font,number_scene, vbom));
		attachChild(new Text(600, engine.getCamera().getCenterY() - 150, resourcesManager.font,trap_destroyed, vbom));
	}
